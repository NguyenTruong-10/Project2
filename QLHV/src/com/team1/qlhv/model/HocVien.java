...
public class HocVien implements Serializable {
	...
	public HocVien(int ma_hoc_vien, String ho_ten, String so_dien_thoai, String dia_chi, Date ngay_sinh,
			boolean gioi_tinh, boolean tinh_trang) {
		super();
